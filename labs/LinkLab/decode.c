...
void decode(instruction_t *ins, code_t *code_ptr, Elf64_Addr code_addr) {
    ...
    if ((code_ptr[0] == 0x48) && (code_ptr[1] == 0x8B) && (MODRM_MOD(code_ptr[2]) == 0) && (MODRM_RM(code_ptr[2]) == 5)) {
        /* movq $<addr>(%RIP), <reg>
    ...
    if ((code_ptr[0] == 0xFF) && (code_ptr[1] == 0x25)) {
        /* jmp <addr> */
    ...
    if ((code_ptr[0] >= 0x70) && (code_ptr[0] <= 0x7F)) {
        /* j[cc] <addr> */
    ...
    if ((code_ptr[0] == 0x0F) && (code_ptr[1] == 0x1F) && (MODRM_REG(code_ptr[2]) == 0)) {
        /* nop */
        ins->op = OTHER_OP;
        ins->length += 3;
    ...
    if ((code_ptr[0] == 0x53)    /* push */
        || (code_ptr[0] == 0x54) /* push */
        || (code_ptr[0] == 0x55) /* push */
        || (code_ptr[0] == 0x5b) /* pop */
        || (code_ptr[0] == 0x5c) /* pop */
        || (code_ptr[0] == 0x5d) /* pop */
        || 0) {
    ...
    if ((code_ptr[0] == 0x63)    /* mov */
        ...
        if (MODRM_MOD(code_ptr[1]) == 3)
            ins->length += 2;
        else if ((MODRM_MOD(code_ptr[1]) == 0) && (MODRM_RM(code_ptr[1]) == 5))
            ins->length += 6;
        else if ((MODRM_MOD(code_ptr[1]) != 3) && (MODRM_RM(code_ptr[1]) == 4)) {
            ins->length += 3;
    ...
    if ((code_ptr[0] >= 0xB8) && (code_ptr[0] <= 0xBF)) {
    ...
    if ((code_ptr[0] == 0x83) && (MODRM_REG(code_ptr[1]) == 7)) {
        /* cmp $<imm>, <reg> */
        ins->op = OTHER_OP;
        ins->length += 3;
        return;
    ...
    if ((code_ptr[0] == 0xf3) && (code_ptr[1] == 0xc3)) {
        /* repz ret */
        ins->op = RET_OP;
        ins->length += 2;
        return;
    ...
    if ((code_ptr[0] == 0xe9) || (code_ptr[0] == 0xeb)) {
        /* jmp <addr> */
    ...
    if ((code_ptr[0] >= 0x90) && (code_ptr[0] <= 0x98)) {
        /* xchg */
        ins->op = OTHER_OP;
        ins->length++;
        return;
